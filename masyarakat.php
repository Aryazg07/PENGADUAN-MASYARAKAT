...
<div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-danger">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                    <span class="fs-2 d-none d-sm-inline">masyarakat</span>
                </a>
        ...
        <div class="col mt-3">
            <div class="container mt-4" style="margin-left:0px;">
                <div class="">
                    <h1><ion-icon name="analytics"></ion-icon>&nbsp;Hasil Laporan</h1>
                </div>
  ...
  <tbody>
    ...
    <td>
    <a href="form_update.php?id_pengaduan=<?= $data['id_pengaduan']; ?>" class="btn btn-success mb-3 rounded"><ion-icon name="create" class="fs-5"></ion-icon></a>&nbsp;
    ...
    <td>
    <a href="detail.php?id_pengaduan=<?= $data['id_pengaduan']; ?>" class="btn btn-danger mb-3 rounded"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
